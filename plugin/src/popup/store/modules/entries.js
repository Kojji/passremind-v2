...
const actions = {
  ...
  checkIfExixts(state, form) {
    return new Promise((res, rej) => {
      const queryRef = query(
        collection(db, "users", form.idToken, "entries"),
  ...
  //         startAt(form.search),
  //         endAt(form.search + "\uf8ff"),
  //         limit(state.getters["getConstLimitPerPage"])
  //       );
  ...
  //           form.idToken,
  //           "entries",
  //           state.getters["getListEntries"][
  //             state.getters["getListEntries"].length - 1
  //           ].id
  //         )
  //       );
  //       const entryQuery =
  ...
  //         component == "list"
  //           ? state.getters["getListEntries"]
  //           : state.getters["getSearchEntries"];
