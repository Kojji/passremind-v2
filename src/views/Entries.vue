...
<template>
  <div class="container mx-auto">
    <div v-if="modal.open">
      <div class="fixed z-50 top-0 left-0 w-screen h-screen flex items-center justify-center" style="background-color:rgba(183,158,127,0.4);" @click="modal.open = false">
    ...
    <div>
      <ul class="flex border-b border-orange-800 mb-2">
        ...
        <li class="-mb-px w-full flex justify-end mb-1 mr-2">
          <a class="inline-block border border-orange-600 rounded py-1 px-3 bg-orange-600 text-zinc-100 cursor-pointer" @click="openCreate()" >Create</a>
        </li>
      </ul>
